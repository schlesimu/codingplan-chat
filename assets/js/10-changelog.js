...
const CHANGELOG_DATA = [
  { v: 'v0.9.12.0', date: '2026-06-17',
    quote: '让后来的人也能上船。',
    items: [
      '新增 API 调用文档：聊天、搜索、模型列表、云同步与 TTS 的接口边界一次讲清',
      '新增 Cloudflare Pages 自部署指南：从 Fork、环境变量到 KV 绑定都有路径',
      '新增环境变量模板、安全说明、贡献指南与 Issue / PR 模板，公开仓库更容易被理解和复刻',
      'README 增加开发者入口，小纸船从一个线上作品，整理成可以被下载、阅读、自部署的图纸',
    ]},

  { v: 'v0.9.11.8', date: '2026-06-17',
